                        ...
                        <tr>
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>SSC</td>
                                        <td><input type="text" name="ssc_board" class="form-control" value="{{  $student->educationalQualification ? $student->educationalQualification->ssc_board : '' }}"></td>
                                        ...
                                        <td><input type="text" name="ssc_group" class="form-control" value="{{  $student->educationalQualification ? $student->educationalQualification->ssc_group : '' }}"></td>
                                    ...
                                    <tr>
                                        <td>HSC</td>
                                        <td><input type="text" name="hsc_board" class="form-control" value="{{  $student->educationalQualification ? $student->educationalQualification->hsc_board : '' }}"></td>
                                        ...
                                        <td><input type="text" name="hsc_group" class="form-control" value="{{  $student->educationalQualification ? $student->educationalQualification->hsc_group : '' }}"></td>
