...
class StudentCreateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'guardian_contact'      => 'required|min:6',
            'relationship'          => 'required|min:2',

            'present_village'       => 'required|min:3',
            'present_post_office'   => 'required|min:3',
            'present_post_code'     => 'required|min:3',
            'present_upazila'       => 'required|min:3',
            'present_district'      => 'required|min:3',
            'permanent_village'     => 'required|min:3',
            'permanent_post_office' => 'required|min:3',
            'permanent_post_code'   => 'required|min:3',
